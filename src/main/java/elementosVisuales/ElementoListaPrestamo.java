...
/**
 * pantalla q miostrara el listado de prestamos
 * 
 * @author AlexLopez
 *
 */
public class ElementoListaPrestamo extends JPanel {

	private Ventana ventana;
	private Prestamo prestamo;

	/**
	 * contructor ElementoListaPrestamo
	 * 
	 * @param v de tipo ventata
	 * @param p de tipo prestamo
	 */
	public ElementoListaPrestamo(Ventana v, Prestamo p) {
		...
		JButton btnBorrarUsuario = new JButton("Borrar Prestamo");
		btnBorrarUsuario.addMouseListener(new MouseAdapter() {
			@Override
			/*
			 * clic q elimina el prestamo
			 */
		...
		JLabel lblNombre = new JLabel(this.prestamo.getNombre());
		...
		JLabel lblImporteFijo = new JLabel(String.valueOf(this.prestamo.isImporteFijo()));
		...
		JLabel lblimporte = new JLabel(String.valueOf(this.prestamo.getImporte()));
		...
		JLabel lblfecha = new JLabel(DateTimeFormatter.ISO_DATE.format(this.prestamo.getFecha()));
		...
		JLabel lblfechaFin = new JLabel((DateTimeFormatter.ISO_DATE.format(this.prestamo.getFechaFin())));
		...
		JLabel lblporcentaje = new JLabel(String.valueOf(this.prestamo.getPorcentajeInteres()));
		GridBagConstraints gbc_lblporcentaje = new GridBagConstraints();
		gbc_lblporcentaje.insets = new Insets(0, 0, 5, 5);
		gbc_lblporcentaje.gridx = 7;
		gbc_lblporcentaje.gridy = 5;
		...
		JLabel lblCodigoMovimiento = new JLabel(String.valueOf(this.prestamo.getCodigoMovimiento()));
