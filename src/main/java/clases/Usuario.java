...
public class Usuario extends EntidadConNombre {
	...
	/**
	 * constructor utilizado para comprar mediante los campos nick y contrsaeÒa si es o no el usuario
	 * @param nick nick de dicho usuario
	 * @param contrasenia contraseÒa de dicho usuario
	 * @throws ContraseniaIncorrectaException exepcion  que salta si la contrseÒa no existe
	 * @throws UsuarioNoExisteException exepcion que salta si el usuari no essite
	 * @throws SQLException exepcion q saÒltara si ahy algun problema de base de datos
	 */
	 ...
	 * @throws SQLException saltara la exepcion si la contraseÒa esta vacia
	 */
