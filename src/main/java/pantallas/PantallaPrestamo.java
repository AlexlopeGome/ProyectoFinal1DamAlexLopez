		...
		Rejistrar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					LocalDate fechaFin = LocalDate.of(Integer.parseInt(fechaPartida2[2]),
							Integer.parseInt(fechaPartida2[1]), Integer.parseInt(fechaPartida2[0]));
					...
					try {
						...
						new clases.Prestamo(nombre, importeFijo, importe, fecha, porcentaje, fechaFin,
								codigoMovimiento);
